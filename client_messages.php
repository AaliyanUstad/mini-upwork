...
// Get all contracts for this client with message info
...
$unread_count = $message->getUnreadCount($client_id);
?>
<!DOCTYPE html>
<html>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="navbar-menu">
                ...
                <a class="nav-link active" href="client_messages.php">
    ...
    <div class="container">
        <div class="page-container">
            <div class="page-header">
                <h1>Messages</h1>
                <p>Communicate with your hired freelancers</p>
            </div>
                ...
                <div class="conversations-list">
                                ...
                                <div class="conversation-card">
                                    ...
                                    <div class="conversation-info">
                                        <div class="freelancer-info">
                                            ...
                                            <?php echo htmlspecialchars($contract_item['f_first_name'] . ' ' . $contract_item['f_last_name']); ?>
                                        </div>
                    ...
                    <?php else: ?>
                        <div class="no-conversations">
                            ...
                            <p>You'll see messages here once you hire freelancers and start working on projects.</p>
                            <a href="post_job.php" class="btn btn-primary">Post a Job</a>
                            <a href="my_jobs.php" class="btn btn-outline">View My Jobs</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
